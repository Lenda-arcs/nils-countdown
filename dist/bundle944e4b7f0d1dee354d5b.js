...
module.exports = __webpack_require__.p + "nils_lol.JPG";
...
var pic_nils = __webpack_require__(/*! ../assets/nils_lol.JPG */ "./assets/nils_lol.JPG");
var body = document.querySelector("body");
var container = document.getElementById("container");
var toPadString = function toPadString(time) {
  return String(time).padStart(2, "0");
};
var x = setInterval(function () {
  var returnDate = new Date("2022-11-27T20:00:00").getTime();
  var currentDate = new Date().getTime();
  var diffTime = returnDate - currentDate;
  ...
  container.innerHTML = "\n    <div class=\"h-32 w-32 bg-cyan-500 shadow-lg shadow-cyan-500/50\">\n      <div>".concat(toPadString(days), "</div>\n      <div>Days</div>\n    </div>\n    <div class=\"h-32 w-32 bg-cyan-500 shadow-lg shadow-cyan-500/50\">\n      <div>").concat(toPadString(hours), "</div>\n      <div>Hours</div>\n    </div>\n    <div class=\"h-32 w-32 bg-cyan-500 shadow-lg shadow-cyan-500/50\">\n      <div>").concat(toPadString(minutes), "</div>\n      <div>Minutes</div>\n    </div> \n    <div class=\"h-32 w-32 bg-cyan-500 shadow-lg shadow-cyan-500/50\">\n      <div>").concat(toPadString(seconds), "</div>\n      <div>Secounds</div>\n    </div>");
  if (diffTime < 0) {
    clearInterval(x);
...
ctaButton === null || ctaButton === void 0 ? void 0 : ctaButton.addEventListener("mousedown", function () {
  var vidContainer = document.createElement("div");
  vidContainer.innerHTML = "<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/dQw4w9WgXcQ\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>";
...
/******/ })()
;
//# sourceMappingURL=bundle944e4b7f0d1dee354d5b.js.map